...
Kot že omenjeno, je v literaturi omenjena časovna zahtevnost $\mathcal{O}(n ^ \frac{4}{3}),$~kar pomeni, da je število konveksnih ovojnic na $n \times n$~mreži $\Theta(n ^ \frac{4}{3})$.
...
\newpage
\section{Rezultati}
Kot že rečeno, se za enakomerne $n \times n$ mreže, za katere je bila v literaturi podana časovna zahtevnost, teoretični in eksperimentalni podatki ujemajo. Časovna zahtevnost izvedbe algoritma na
...
$\mathcal{O}(n)$, za Cantorjeve mreže pa $\mathcal{O}(n^2)$ (za $n \leq 35$), kar se ravno tako ujema z literaturo.
...
pa sva ocenila, da je za take mreže časovna zahtevnost algoritma $\mathcal{O}((mn)^{\frac{2}{3}})$. 
