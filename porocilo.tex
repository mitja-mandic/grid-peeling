...
Za boljšo predstavo, kako algoritem deluje, sva postopek lupljenja konveksnih ovojnic prikazala na dveh primerih. Prvi, ki je prikazan na sliki \ref{fig:11x11}, je postopek lupljenja 
navadne mreže$11 \times 11$, drugi, prikazan na sliki \ref{fig:5x5}, pa je postopek izveden na potenčni mreži velikosti $5 \times 5$, torej s točkami na mreži $16 \times 16$, ki so 
potence števila $2$.
...
\begin{figure}[!h]
	...
	\label{fig:11x11}
	\vspace{2mm}
	\includegraphics[scale=0.6]{11x11_enakomerna.png}
\end{figure}
...
\begin{figure}[!h]
	...
	\label{fig:5x5}
	\vspace{2mm}
	\includegraphics[scale=0.6]{5x5_potencna.png}
\end{figure}
...
Na grafu \ref{fig:st_ovojnic} je predstavljeno število ovojnic izvedenega algoritma v odvisnosti od $n$, kjer za $n$ vzamemo naravna števila od $1$ do $150$. Opazimo, da se razmerju med 
...
$0,25 \cdot n ^ \frac{4}{3}$. Ta primer je prikazan na grafu \ref{fig:st_ovojnic_potencna}. Časovna zahtevnost je torej spet $\mathcal{O}(n ^ \frac{4}{3})$.
...
tisti na navadni mreži (razlikujeta se le v koeficientu, ki je pri potenčnih mrežah nižji).
